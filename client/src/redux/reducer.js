...
export default function reducer(state = initialState, { type, payload }) {
  switch (type) {
    case GET_DOGS: // Reducer para actualizar a todos los perros
      return {
        ...state,
        allDogs: payload,
    ...
    case FILTER_BY_TEMPERAMENT: {
      ...
      filteredDogsData = state.allDogs.filter(
        (dog) => dog.temperament && dog.temperament.includes(filterTemperament)
      );
